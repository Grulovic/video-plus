...
<!--                             <img src="logo.png" style="height: 100px;" alt=""> -->
                               ...
                               <tbody>
                                  <tr>
                                     <td style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';max-width:100vw;padding:32px">
                                        <span class="im">
                                           <h1 style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';color:#3d4852;font-size:18px;font-weight:bold;margin-top:0;text-align:left">New Gallery Uploaded</h1>
  ...
  @endforeach
      ...
      <small>{{ date('j. F Y. H:i', strtotime($gallery->created_at)) }}</small>
    <div class="card-body pt-0" style="overflow: hidden;">
      <a href="{{ route('photos.show',$gallery->id)}}" class="text-black"><h2 class="pb-0 mb-0">
        {{ $gallery->name }} </h2></a>
