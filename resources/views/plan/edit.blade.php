...
{{--        <input type="datetime-local" name="date" class="form-control" placeholder="Enter date" value="{{ date_format(date_create($plan->date),'Y-m-d')."T".date_format(date_create($plan->date),'h:i:s') }}">--}}
    ...
    <div class="form-group col-lg-3">
        <strong>Time</strong>
        <input id="timepicker" type="text" name="time" class="form-control" placeholder="Enter date" value="{{ date_format(date_create($plan->date),'h:i a') }}"  autocomplete="off">{{ date_format(date_create($plan->date),'h:i a') }}
    ...
    <div class="col-lg-12">
        ...
        <div class="input-group  mb-2">
            ...
            <div class="form-check  form-check-inline mt-3">
                <input class="form-check-input" type="radio" name="email_push" id="email_push_admin" value="admin">
            ...
            <div class="form-check  form-check-inline mt-3">
                <input class="form-check-input" type="radio" name="email_push" id="email_push_all" value="all" checked="">
                <label class="form-check-label video-thumbnail" for="email_push_admin">
