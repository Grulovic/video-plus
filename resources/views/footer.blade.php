<div class="container-fluid  pb-0 mb-0 justify-content-center text-muted shadow-lg border-top"
     style="background-color2:#c7363d; ">
    <footer class="max-w-7xl  mx-auto " style="">
        <div class="row justify-content-center pt-5 pb-5">
            <div class="col-11">
                <div class="row ">
                    <div class="col-xl-8 col-md-4 col-sm-4 col-12 my-auto mx-auto a ">
                        <a href="{{route('about')}}"><img
                                src="{{ url('uploads/settings/'.settings()->get('logo_footer')) }}"
                                style="max-height: 100px; " class="mb-5"></a>
                    ...
                    <div class="col-xl-2 col-md-4 col-sm-4 col-12">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="{{route('impresum')}}">Impresum</a></li>
                        </ul>
                    </div>
                    <div class="col-xl-2 col-md-4 col-sm-4 col-12">
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="contact_us" tabindex="-1" role="dialog" aria-labelledby="contact_us"
                             aria-hidden="true">
                                        ...
                                        <form action="{{ route('contact') }}" method="POST" name="contact">
                                            ...
                                            <div class="form-group col-12">
                                                ...
                                                <textarea type="text" name="message" class="form-control"
                                                          ...
                                                          style="min-height: 106px;"></textarea>
