...
class HomeController extends Controller
{
    public function index(){
        ...
        $most_articles_id = ArticleCategory::groupBy('category_id')->select('category_id', DB::raw('count(*) as total'))->orderBy('total','desc')->get()->first()->category_id;
        ...
        $most_videos_id = VideoCategory::groupBy('category_id')->select('category_id', DB::raw('count(*) as total'))->orderBy('total','desc')->get()->first()->category_id;
        ...
        $most_photos_id = GalleryCategory::groupBy('category_id')->select('category_id', DB::raw('count(*) as total'))->orderBy('total','desc')->get()->first()->category_id;
